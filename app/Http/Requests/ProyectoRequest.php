...
class ProyectoRequest extends FormRequest
{
    ...
    {
        return [
            'foto'        => ['required', 'file', 'image', 'dimensions:min_width=700,min_height=500,max_width=1200,max_height=764', 'max:1000000', 'mimes:jpg,jpeg,png'],
            ...
            'titulo'      => ['required', 'string', 'unique:proyectos', 'min:3', 'max:50'],
    ...
    {
        return [
            'foto.required' => 'La imagen del proyecto es requerido',
